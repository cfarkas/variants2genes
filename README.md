...
```
- After these steps, a folder named ```variants2genes_$DATE_OF_EXECUTION``` where $DATE_OF_EXECUTION = ```Day:Month:Year_Hour:Minute:Sec``` when the run was executed, will contain the results. 
